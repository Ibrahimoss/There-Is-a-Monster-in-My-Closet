...
##
## R icon    — retired: the interact prompt now sits on the object itself
##              (HUD world prompt). The node stays for layout, always hidden.
...
## Kept for reference; the world prompt replaced it.
